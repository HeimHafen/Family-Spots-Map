...
export function renderSpotList(spots, options) {
  ...
  spots.forEach((spot) => {
    ...
    // Favoriten-Stern (nur Anzeige; das echte Toggle passiert im Detailpanel)
 ...
 *
 * @param {Object} spot
 * @param {{isFavorite: boolean, onToggleFavorite: (spotId: string) => void}} options
 */
...
/**
 * Toast-Anzeige für kurze Nachrichten.
 *
