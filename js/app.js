...
function init() {
  ...
  // Tilla Spielideen-Button
  tillaGamesBtnEl = document.getElementById("tilla-games-btn");
  ...
  // Tilla – Spielideen-Button klickt Toast mit zufälligem Spiel
  if (tillaGamesBtnEl) {
    tillaGamesBtnEl.addEventListener("click", () => {
